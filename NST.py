...
def build_loss(neural_net, optimizing_img, target_representations, content_feature_maps_index, style_feature_maps_indices, config):
    ...
    '''
    target_content_representation = target_representations[0]  #[512,28,28]
    target_style_representation = target_representations[1]    #[ [1,64,224,224],[1,128,112,112],[1,256,56,56],[1,512,28,28],[1,512,14,14] ]
...
if __name__ == "__main__":
    ...
    optimization_config['content_weight'] = 100000.0
    optimization_config['style_weight'] = 30000.0
    #optimization_config['style_weight'] = 10000.0
    optimization_config['tv_weight'] = 1.0
    optimization_config['content_images_dir'] = os.path.join(default_resource_dir, 'content-images')
    optimization_config['style_images_dir'] = os.path.join(default_resource_dir, 'style-images')
    optimization_config['output_img_dir'] = os.path.join(default_resource_dir, 'output-images')
